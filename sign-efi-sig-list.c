...
{
  printf("Usage: %s [-r] [-m] [-a] [-g <guid>] [-o] "
         "[-t <timestamp>] [-i <infile>] [-c <crt file>] "
         "[-k <key file>] [-e <engine>] <var> <efi sig list file> "
         "<output file>\n",
         progname);
}
